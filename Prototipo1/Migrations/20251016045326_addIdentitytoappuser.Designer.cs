...
namespace Prototipo1.Migrations
{
    ...
    [Migration("20251016045326_addIdentitytoappuser")]
    partial class addIdentitytoappuser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prototipo1.Models.TipoUsuario", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdTipoUsuario = 2,
                            NombreTipoUsuario = "Ingeniero"
                        },
                        new
                        {
                            IdTipoUsuario = 3,
                            NombreTipoUsuario = "Bodeguero"
                        });
                });
            ...
            modelBuilder.Entity("Prototipo1.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Prototipo1.Models.AppUser", b =>
                {
                    b.HasOne("Prototipo1.Models.TipoUsuario", "TipoUsuario")
                        .WithMany()
