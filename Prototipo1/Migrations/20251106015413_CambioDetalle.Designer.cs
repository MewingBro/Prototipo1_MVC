...
namespace Prototipo1.Migrations
{
    ...
    [Migration("20251106015413_CambioDetalle")]
    partial class CambioDetalle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prototipo1.Models.Cambio", b =>
                {
            ...
            modelBuilder.Entity("Prototipo1.Models.CambioDetalle", b =>
                {
                    b.Property<int>("IdCambioDetalle")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdCambioDetalle"));

                    b.Property<double>("CantidadDisminuida")
                        .HasColumnType("float");
                    ...
                    b.HasKey("IdCambioDetalle");

                    b.HasIndex("IdCambio");

                    b.HasIndex("IdProducto");

                    b.ToTable("CambioDetalle");
                });
            ...
            modelBuilder.Entity("Prototipo1.Models.Producto", b =>
                {
                    ...
                    b.Property<int>("MediaAritmetica")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prototipo1.Models.UsuariosProyectos", b =>
                {
                    b.Property<int>("IdUsuariosProyectos")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdUsuariosProyectos"));
            ...
            modelBuilder.Entity("Prototipo1.Models.CambioDetalle", b =>
                {
                    b.HasOne("Prototipo1.Models.Cambio", "Cambio")
                        .WithMany()
